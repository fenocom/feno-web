...
export function CanvasProvider({ children }: { children: ReactNode }) {
    ...
    useEffect(() => {
        ...
        async function fetchCanvasEntities() {
            try {
                ...
                logger.error({ error: err }, "Error fetching canvas entities");
        ...
        fetchCanvasEntities();
    }, [websiteId, isRouteLoading, supabase]);
    ...
    const addEntity = async (
        ...
        try {
            ...
            logger.error({ error: err }, "Error adding entity");
    ...
    const updateEntity = async (id: string, updates: Partial<CanvasEntity>) => {
        try {
            ...
            logger.error({ error: err }, "Error updating entity");
    ...
    const deleteEntity = async (id: string) => {
        try {
            ...
            logger.error({ error: err }, "Error deleting entity");
