          ...
          content: [
            {
              ...
              attrs: {
                ...
                alt: "Profile Photo",
                style:
                  "width: 100%; height: auto; border-radius: 4px; display: block; margin-bottom: 20px;",
              },
            },
            {
              type: "heading",
              attrs: {
                level: 1,
                styles: { "font-size": "2.2rem", "line-height": "1.2" },
              },
            ...
            { type: "paragraph" },
            {
              ...
              content: [
                ...
                { type: "hardBreak" },
                { type: "text", text: "177 Great Portland Street, London" },
                { type: "hardBreak" },
            ...
            { type: "paragraph" },
            {
              type: "paragraph",
              content: [
                { type: "text", marks: [{ type: "bold" }], text: "E-mail:" },
                { type: "hardBreak" },
                { type: "text", text: "susan.williams@coolfreecv.com" },
              ],
            },
            { type: "paragraph" },
            {
              ...
              content: [
                ...
                { type: "hardBreak" },
                { type: "text", text: "linkedin.com/susan.williams" },
              ],
            },
            { type: "paragraph" },
            {
              type: "paragraph",
              content: [
                { type: "text", marks: [{ type: "bold" }], text: "WWW:" },
                { type: "hardBreak" },
                { type: "text", text: "https://www.coolfreecv.com" },
              ],
            },
            { type: "paragraph" },
            {
              ...
              content: [{ type: "text", text: "Additional Skills" }],
            },
            { type: "horizontalRule" },
            { type: "paragraph" },
            {
              ...
              content: [
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [{ type: "text", text: "Results-oriented" }],
                    },
                  ],
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [
                        { type: "text", text: "Organisational capacity" },
                      ],
                    },
                  ],
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [{ type: "text", text: "Revenue generation" }],
                    },
                  ],
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [{ type: "text", text: "Business development" }],
                    },
                  ],
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [{ type: "text", text: "Effective marketing" }],
                    },
                  ],
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [
                        { type: "text", text: "Operability and commitment" },
                      ],
                    },
                  ],
                },
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [
                        { type: "text", text: "Ability to motivate staff" },
                      ],
                    },
                  ],
                },
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [
                        { type: "text", text: "Maintain good relations" },
                      ],
                    },
                  ],
                },
                ...
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [{ type: "text", text: "Resistance to stress" }],
                    },
                  ],
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [{ type: "text", text: "Good manners" }],
                    },
                  ],
                },
              ],
          ...
          content: [
            {
              ...
              attrs: {
                level: 2,
                styles: { "font-size": "1.6rem", "font-weight": "bold" },
              },
            ...
            { type: "paragraph" },
            {
              ...
              content: [
                {
                  type: "gridColumn",
                  attrs: { styles: { padding: "0", "font-weight": "bold" } },
                  content: [
                    {
                      type: "paragraph",
                      content: [
                ...
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [{ type: "text", text: "09/2015 to 05/2019" }],
                    },
                  ],
                },
              ],
              ...
              content: [
                {
                  ...
                  content: [
                    ...
                    },
                    {
                      type: "paragraph",
                      content: [
                        { type: "text", text: "Technical Institute, NY" },
                      ],
                    },
                  ],
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [{ type: "text", text: "2009-2015" }],
                    },
                  ],
                },
              ],
              ...
              content: [
                ...
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      content: [{ type: "text", text: "2015-2018" }],
                    },
                  ],
                },
              ],
            ...
            {
              type: "paragraph",
              content: [{ type: "text", text: "Spanish — Intermediate" }],
            },
            { type: "paragraph" },
            {
              type: "heading",
