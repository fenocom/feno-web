...
export const Navbar = () => {
  return (
    <header className="fixed min-w-[90vh] max-w-[400px] top-5 left-[50%] isolate transform bg-white/1 -translate-x-[50%] rounded-2xl z-50 backdrop-blur-sm border border-white/5">
