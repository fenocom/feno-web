"use client";
import { type Colors, Liquid } from "@/components/common/liquid-gradient";
    ...
    return (
        <div className="flex justify-center">
            <a
                href="/portfolio"
                target="_blank"
                className="relative inline-block w-28 h-9 mx-auto group dark:bg-black bg-white dark:border-white border-2 border-black rounded-full overflow-hidden"
                rel="noreferrer"
            >
                ...
                >
                    <span className="flex items-center justify-center px-2 gap-1 rounded-lg group-hover:text-yellow-400 text-white text-sm font-semibold tracking-wide whitespace-nowrap">
                        Portfolio
