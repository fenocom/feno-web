...
export default function Toolbar({ onExport, getEditorContent }: ToolbarProps) {
        ...
        useEffect(() => {
                if (!isSettingsOpen && !isSaveMode) return;
        ...
        return (
                ...
                >
                        <div className="relative z-10 text-black">
                                <motion.div layout className="border border-black/10 rounded-4xl bg-white">
                                                                ...
                                                                <div className="flex gap-2 items-center px-3 py-2">
                                                                        ...
                                                                        <div className="flex gap-1 items-center">
                                                                                ...
                                                                                <Button
                                                                                        ...
                                                                                        className={`p-1 min-w-8 h-8 rounded-md hover:bg-black/10 ${isSettingsOpen ? "bg-black/10" : ""
                                                                                                } text-black`}
                                                                                >
