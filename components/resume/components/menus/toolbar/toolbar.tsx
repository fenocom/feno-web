                                        ...
                                        <div className="flex gap-2 items-center px-3 py-2 whitespace-nowrap">
                                                ...
                                                <div className="flex gap-1 items-center">
                                                        <Button
                                                                ...
                                                                className={`p-1 min-w-8 h-8 rounded-md hover:bg-black/10 ${activePanel === "templates" ? "bg-black/10" : ""
                                                                        } text-black`}
                                                        >
                                                                <IconPalette size={18} />
                                                        </Button>
                                                        ...
                                                        <Button
                                                                ...
                                                                className={`p-1 min-w-8 h-8 rounded-md hover:bg-black/10 ${activePanel === "settings" ? "bg-black/10" : ""
                                                                        } text-black`}
                                                        >
                                                        ...
                                                        {isAdmin && getEditorContent && (
                                                                <Button
                                                                        ...
                                                                        className={`p-1 min-w-8 h-8 rounded-md hover:bg-black/10 ${activePanel === "save" ? "bg-black/10" : ""
                                                                                } text-black`}
                                                                >
