...
export function Toolbar({ onExport, getEditorContent }: ToolbarProps) {
    ...
    const containerVariants: Variants = {
        ...
        visible: {
            y: 0,
            opacity: 1,
            width: activePanel === "templates"
                ? "90vw"
                : activePanel === "save"
                    ? "700px"
                    : "auto",
            height: activePanel === "templates" && isTemplatesExpanded
                ? "90vh"
                : "auto",
            transition: {
                type: "spring",
    ...
    return (
        <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="fixed bottom-6 left-1/2 -translate-x-1/2 shadow-xl z-50 rounded-4xl bg-white overflow-hidden flex flex-col-reverse"
                    ...
                    {activePanel === "templates" && (
                         ...
                         >
                            <TemplatesPanel
                                ...
                                onToggleExpand={() => setIsTemplatesExpanded(!isTemplatesExpanded)}
                            />
                         </motion.div>
                    )}
