    ...
    return (
        <Popover isOpen={isOpen} onOpenChange={setIsOpen}>
            ...
            <Popover.Content
                ...
                placement="top"
            >
                <div className="bg-white p-3 rounded-xl border border-black/10 shadow-xl relative">
                    <HexColorPicker
                        color={
                    ...
                    <div className="flex gap-1 mt-2 flex-wrap w-[170px]">
                        ...
                        {type === "highlight" && (
                            <button
                                type="button"
                                className="w-5 h-5 rounded-full border border-black/20 bg-transparent flex items-center justify-center relative overflow-hidden"
                                onClick={() =>
                                    editor
                                        .chain()
                                        .focus()
