...
export const PORTFOLIO_TEMPLATES: PortfolioTemplate[] = [
    ...
    },
    {
        ...
        prompt: "Create a bold educational website with a light background, strong serif typography, and high contrast sections. Focus on front-end web development articles, premium courses, and newsletters. Highlight popular topics with tag-based navigation.",
        mimeType: "image/webp",
    },
];
